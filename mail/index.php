...
?>
<b>Name:</b><br><input type="text" name="name" size="50" maxlength="255" value="<?php echo $name; ?>"><br><br>
<?php
...
?>
<b>E-Mail:</b><br><?php if (empty($email)) { echo "<input type=\"text\" name=\"email\" size=\"50\" maxlength=\"255\"><br><br>"; } else { echo "<input type=\"hidden\" name=\"email\" value=\"$email\"> <a class=\"link_onf7f7f7\" href=\"mailto:$email\">$email</a><br><br>"; } ?>
<br>
<?php
