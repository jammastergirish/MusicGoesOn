...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 0,4");
...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 5,0");
while ($data = mysqli_fetch_array($result))
{
 $id = $data['id'];
 include("inc/story.inc");
...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 0,2");
while ($data = mysqli_fetch_array($result))
{
 $id = $data['id'];
 include("inc/story.inc");
...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 2,3");
while ($data = mysqli_fetch_array($result))
{
 $id = $data['id'];
 include("inc/story.inc");
...
$nowplaying = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM nowplaying ORDER BY date DESC LIMIT 0,1"));
...
$oftheweek = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM oftheweek WHERE _of = 'single' AND date <= '".datetime(date)."' ORDER BY date DESC LIMIT 0,1")); $review = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM mgo WHERE id = '$oftheweek[review]'")); echo "<CENTER>".icon($oftheweek[review])."<br>"; echo "<i>$oftheweek[title]</i><br><b>$oftheweek[artist]</b><br>[<a class=\"link_onf7f7f7\" href=\"/article.php/$oftheweek[review]/\">REVIEW</a>]</CENTER>\n";
echo "</font></td></tr></table>";
*/
...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 0,1");
while ($data = mysqli_fetch_array($result))
{
 $id = $data['id'];
 include("inc/story.inc");
...
$result = mysqli_query($link, "SELECT * FROM mgo WHERE section LIKE '%$section%' AND datetime <= '".datetime()."' ORDER BY datetime DESC LIMIT 1,1");
while ($data = mysqli_fetch_array($result))
{
 $id = $data['id'];
 include("inc/story.inc");
