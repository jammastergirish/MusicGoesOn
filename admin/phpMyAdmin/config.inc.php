 ...
 */
$cfgPmaAbsoluteUri = 'http://www.musicgoeson.com/admin/phpMyAdmin/';
...
$cfgServers[1]['user']          = 'mgo';      // MySQL user (only needed with basic auth)
$cfgServers[1]['password']      = 'h47fh20e';          // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db']       = 'musicgoeson_com';          // If set to a db-name, only this db is accessible
