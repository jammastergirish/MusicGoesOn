<?php
/* $Id: chinese_big5.inc.php,v 1.57 2001/08/30 18:20:56 swix Exp $ */
...
$strEnableMagicQuotes = '<b>警告:</b> 您沒有在您的 PHP 設定中啟用 magic_quotes_gpc 這個功能，PhpMyAdmin 需要這個功能才能正確地執行<br />要了解如何啟動這個功能，請參考 PHP 使用手冊中關於組態設定 (configuration) 這一節的內容';
$strEnclosedBy = '要用什麼字元包括起來';
$strEnd = '最後一頁';
