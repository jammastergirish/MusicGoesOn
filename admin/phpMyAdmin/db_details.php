<?php
/* $Id: db_details.php,v 1.73 2001/08/29 07:15:40 loic1 Exp $ */
...
<tr bgcolor="<?php echo $bgcolor; ?>">
    ...
    <td>
        <a href="sql.php?<?php echo $url_query; ?>&reload=true&sql_query=<?php echo urlencode('DROP TABLE ' . backquote($table)); ?>&zero_rows=<?php echo urlencode($strTable . ' ' . htmlspecialchars($table) . ' ' . $strHasBeenDropped); ?>">
            <?php echo $strDrop; ?></a>
    </td>
    <td>
...
<tr bgcolor="<?php echo $bgcolor; ?>">
    ...
    <td>
        <a href="sql.php?<?php echo $url_query; ?>&sql_query=<?php echo urlencode('SELECT * FROM ' . backquote($table)); ?>&pos=0"><?php echo $strBrowse; ?></a>
    </td>
    <td>
    ...
    <td>
        <a href="sql.php?<?php echo $url_query; ?>&reload=true&sql_query=<?php echo urlencode('DROP TABLE ' . backquote($table)); ?>&zero_rows=<?php echo urlencode($strTable . ' ' . htmlspecialchars($table) . ' ' . $strHasBeenDropped); ?>"><?php echo $strDrop; ?></a>
    </td>
    <td>
        <a href="sql.php?<?php echo $url_query; ?>&sql_query=<?php echo urlencode('DELETE FROM ' . backquote($table)); ?>&zero_rows=<?php echo urlencode($strTable . ' ' . htmlspecialchars($table) . ' ' . $strHasBeenEmptied); ?>"><?php echo $strEmpty; ?></a>
    </td>
    <td align="right">
...
if ($cfgAllowUserDropDatabase || $is_superuser) {
    ...
    <!-- Drop database -->
    <li>
        <a href="sql.php?server=<?php echo $server; ?>&lang=<?php echo $lang; ?>&db=<?php echo urlencode($db); ?>&sql_query=<?php echo urlencode('DROP DATABASE ' . backquote($db)); ?>&zero_rows=<?php echo urlencode($strDatabase . ' ' . htmlspecialchars(backquote($db)) . ' ' . $strHasBeenDropped); ?>&goto=main.php&back=db_details.php&reload=true">
